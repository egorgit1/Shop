...
import com.example.deb3.databinding.ActivityShowStudentsBinding
import kotlin.concurrent.thread

class ShowStudentsActivity : AppCompatActivity(), StudentAdapter.Listener {

    lateinit var conditions: Array<String>
    lateinit var binding: ActivityShowStudentsBinding
    ...
    override fun onResume() {
        ...
        thread {
            ...
            adapter.addAllStudents(listOfStudents)
        }
        binding.bSearch.setOnClickListener{
            if (makeSearchCorrect(binding.edSearch.text.toString()) == null)
                Toast.makeText(
                    this@ShowStudentsActivity,
    ...
    override fun onClick(student: StudentInDB) {
        Toast.makeText(this, "${student.surname} ${student.name} ${student.patronymic}", Toast.LENGTH_SHORT).show()
    }
